...
int main()
{
    ...
    int *result1mean = aggregate(ints, sizeof (int), n, addIntInitialPointer, &mean);

    //<WRITE YOUR CODE HERE>;

    printf("%d\n", *result1mean);

    double *result2mean = aggregate(doubles, sizeof (double), n, addDoubleInitialPointer, &mean);
